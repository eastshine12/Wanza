...
--------------------질문과답변 디테일-------------------------
CREATE SEQUENCE SEQ_QUESTIONDETAIL
START WITH 1
INCREMENT BY 1;
...
DROP SEQUENCE SEQ_QUESTIONDETAIL;

CREATE TABLE QUESTIONDETAIL(
    QUESTIONDETAILSEQ NUMBER(8) PRIMARY KEY,
    QUESTIONDETAILTITLE VARCHAR2(100) NOT NULL,
    QUESTIONDETAILCONTENT VARCHAR2(500) NOT NULL,
    QUESTIONDETAILREADCOUNT NUMBER(8) NOT NULL,
    QUESTIONDETAILREGDATE DATE NOT NULL,
    
    QUESTIONDETAILFILENAME VARCHAR2(500),
    QUESTIONDETAILNEWFILENAME VARCHAR2(500),
    QUESTIONDETAILDEL NUMBER(8) NOT NULL,
    
    QUESTIONDETAILREF NUMBER(8) NOT NULL,
    QUESTIONDETAILSTEP NUMBER(8) NOT NULL,
    QUESTIONDETAILDEPTH NUMBER(8) NOT NULL
);
